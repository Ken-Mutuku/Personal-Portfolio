...
try {
    ...
    //Recipients
    $mail->setFrom('patkenmtuku@gmail.com', 'Personal Portfolio');
    $mail->addAddress('patkenmtuku@gmail.com', 'Shadel Montessori');     //Add a recipient
    ...
    if($mail->send())
    {
        $_SESSION['status'] = "Thank you for contacting us- Perfomance and Security by Westvolt";
